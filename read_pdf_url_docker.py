...
import datetime
import sys
sys.path.append('/WHO_pdf_reader/src')
...
df_h7n9.to_csv('/WHO_pdf_reader/results/WHO-avian-flu-H7N9-reports_2017-present.csv')
df_h5n1.to_csv('/WHO_pdf_reader/results/WHO-avian-flu-H5N1-reports_2017-present.csv')
